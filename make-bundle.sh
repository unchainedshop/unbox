...
docker build -q -t registry.ucc.dev/unchained/cryptopay:box -f ./cryptopay/Dockerfile ./cryptopay
...
docker image save -o ./bundle/cryptopay.tar registry.ucc.dev/unchained/cryptopay:box
